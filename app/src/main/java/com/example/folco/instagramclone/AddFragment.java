...
public class AddFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addUpload = (Button) view.findViewById(R.id.addUpload);
        ...
        addUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                userNow.getPosts().add(new Pair<Timestamp, Bitmap>(new Timestamp(System.currentTimeMillis()), bitmap));

                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(getActivity());
                alertDialogBuilder.setMessage("Uploaded..!!!");
    ...
    public  void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(resultCode== Activity.RESULT_OK) {
            ...
            if(requestCode==REQUEST_CAMERA){
                ...
                try {
                    addImage.setImageBitmap(scaleImage(getActivity(),selectedImageUri));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
            ...
            addUpload.setVisibility(View.GONE);
        }
    }
